...
In early 2017, several months into my role as Global Head of Risk Identification at Credit Suisse, I received the first round of bottom-up risk assessments from the business units. I had designed a standardised template, distributed it with detailed guidance, and given the business units eight weeks to complete their submissions. The results arrived on schedule. I opened the first one — a major trading division — and compared it against the prior year's submission that I had retrieved from the archives.
