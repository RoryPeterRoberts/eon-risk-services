...
A second illustration from the same month reinforces the point. Signature Bank, with $110 billion in assets, failed on 12 March 2023, two days after SVB. Signature had built significant deposit concentration in the cryptocurrency sector. As the crypto market deteriorated through 2022 — the collapse of TerraUSD in May, Celsius Network in June, FTX in November — each event was a trigger that should have activated event-driven re-identification of Signature's concentration risk. The quarterly cycle should have shown deposit concentration shifting from a strategic advantage to an existential vulnerability. It did not. Signature became the third-largest bank failure in American history.
