...
Building the first interaction matrix at an institution typically reveals extensive connections — counterparty credit risk may connect through trigger or amplification relationships to ten or more other material risks. These connections are not surprises to experienced practitioners. What the matrix provides is explicit documentation and traceability. The interaction matrix turns intuition into auditable methodology.
