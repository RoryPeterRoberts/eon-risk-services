# Chapter 12: Integration: Capital Planning, Strategy, and the Board
...
In many institutions, the risk identification process is rigorous and the capital planning process is rigorous, yet the two operate as parallel universes. At one institution, the risk inventory contained nearly forty material risks. The ICAAP addressed fewer than half. The gap was not deliberate — it was structural. Different teams, different timelines, different reporting lines, different systems.
...
The methodology maps to all eight components of the COSO ERM framework. This mapping was introduced in Chapter 2 as part of the standards architecture. Here, in the context of integration, the mapping serves a practical purpose: it demonstrates to regulators and stakeholders that the risk identification process satisfies the requirements of an internationally recognised ERM framework, and that no component of enterprise risk management has been inadvertently omitted.

| COSO ERM Component | Process Mapping |
|---|---|
| **Internal Environment** | Phase 1: Internal Environment Assessment — 7 COSO elements (Ch 5) |
| **Objective Setting** | Phase 1: Strategic objectives, risk criteria, risk appetite (Ch 5) |
| **Event Identification** | Phase 2: Dual-track identification, SWIFT, Delphi (Ch 6–7) |
| **Risk Assessment** | Phase 3: Four-dimensional scoring, data quality (Ch 9) |
| **Risk Response** | Phase 3: Cost-benefit assessment, control effectiveness (Ch 9–10) |
| **Control Activities** | Phase 2: Bottom-up control assessment; Phase 3: Bow-tie control mapping (Ch 7, 10) |
| **Information & Communication** | Cross-cutting: Communication and consultation (Ch 3); Phase 4: Documentation (Ch 11) |
| **Monitoring** | Phase 6: Quarterly refresh, KRI monitoring, event-driven updates (Ch 13) |
...
**Reverse stress testing.** The ICAAP must include reverse stress testing — identifying the scenarios that would render the institution non-viable. These scenarios are constructed by working backwards from the inventory: which risks, if they materialised simultaneously at their worst credible severity, would breach the institution's viability threshold? The risk interaction analysis from Chapter 10 — cascade pathways, propagation nodes, simultaneous crystallisation assessment — provides the analytical basis for constructing these scenarios. Reverse stress testing is identification in reverse: instead of asking "what risks exist?", it asks "which combination of identified risks could destroy us?"

**Specific risk categories requiring ICAAP/ILAAP attention.** Certain risk categories demand dedicated treatment in capital planning: credit concentration risk, interest rate risk in the banking book (IRRBB), pension obligation risk, step-in risk, securitisation risk, excessive leverage risk, and climate-related financial risk. The taxonomy from Chapter 4 ensures these categories are captured in the inventory. The ILAAP additionally requires that liquidity risks — intraday liquidity, contingent liquidity demands, currency mismatch — receive dedicated scenario treatment informed by the treasury risk sub-process described in Chapter 7.
...
Chapter 1 identified **Regulatory Arbitrage Masking** as one of the ten recurring failure modes — the pattern where institutions structure activities to minimise regulatory capital requirements in ways that obscure the economic risk. This chapter delivers the methodology's response.
...
Chapter 3 defined the principal risk report as containing ten items:
...
**The data quality distribution.** Item 8 — the distribution of data quality ratings across the material risk portfolio — tells the Board how much confidence to place in the overall risk picture. A portfolio where 60% of material risks carry High or Medium data quality ratings is more reliable than one where 40% are Low or Very Low. The Board should challenge management on Low-rated risks: what is being done to improve the evidence base? What conservatism adjustments have been made in the capital assessment? The data quality framework from Chapter 9 becomes, through this reporting mechanism, a Board governance tool.

**The enterprise portfolio view.** Item 9 — the aggregate risk position against institutional appetite — is the single most important item in the report for Board governance. It answers the question: "considering all identified risks and their interactions, is this institution within the boundaries the Board has set?" If the answer is no, the Board must act — by directing risk reduction, by adjusting appetite (with documented justification), or by allocating additional capital. The enterprise portfolio view from Chapter 8, updated through the ongoing cycle described in Chapter 13, provides this answer at every Board meeting.
