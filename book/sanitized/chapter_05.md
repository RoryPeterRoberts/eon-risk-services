# Chapter 5: Setting the Context: External, Internal, and Risk Culture

## The Bank That Didn't See the Crisis Coming

In October 2007, a German mortgage bank was hiring financial risk managers to price CDOs and mortgage-backed securities — the products that were, at that very moment, beginning to destroy the global financial system.
...
By October 2007, the external environment had already changed in ways that made Depfa's business model existentially fragile. BNP Paribas had suspended three funds exposed to US subprime in August 2007. Northern Rock had experienced the first British bank run in 150 years in September. Interbank lending rates were spiking. Central banks were injecting emergency liquidity. The wholesale funding markets on which Depfa depended for its survival were under unprecedented stress.
...
What stands out from that period is how absorbed the technical teams were in the complexity of measuring the risks, and how completely absent any discussion of the meta-question: *do we have a very risky portfolio?* The quants were pricing CDO tranches. The traders were managing hedges. The risk managers were producing VaR numbers and stress test outputs. Everyone was doing their job. But no one was stepping back to ask whether the portfolio itself — its concentration, its funding dependency, its exposure to a single macro scenario — constituted a risk that should be named, owned, and escalated.

The front-office teams had no structured engagement with enterprise risk management on these questions. From a risk measurement perspective, the decisions had already been taken. The portfolio existed. The business model was set. The technical teams were there to produce numbers — to measure the risks that had already been accepted, not to question whether they should have been accepted in the first place. Everything felt entirely normal. Until the layoffs started.

Working inside a failing institution demonstrates that the most technically sophisticated risk measurement in the world is worthless if the foundation — the systematic assessment of the environment in which those risks exist — is absent. The PESTLE framework described in this chapter exists because of exactly this failure. It forces the institution to map the external environment to the specific vulnerabilities of its own business model *before* identification begins — so that risks like "wholesale funding market closure in a bank dependent on wholesale funding" cannot remain unasked questions.
...
The answer, when it came in September 2007, was a bank run. Northern Rock experienced the first run on a British bank in 150 years. It was nationalised in February 2008. Taxpayers lost approximately £2 billion.
...
**Materiality threshold.** The point at which a risk is classified as material and receives full treatment in the risk inventory, including assignment of a risk owner, detailed assessment, and inclusion in Board reporting. The materiality threshold is a governance decision — it determines the boundary between the risks that the Board sees and the risks that are managed at lower levels. Setting it too high creates blind spots. Setting it too low overwhelms the Board with noise.
...
In practice, framing matters enormously. When the straw man is presented as "the proposed risk list" rather than "the starting point for discussion", participants defer to it. When it is presented as "here is what the evidence shows — now tell me what is wrong with it", the workshops produce genuine challenge, debate, and identification of risks the straw man has missed. The framing matters as much as the content.
