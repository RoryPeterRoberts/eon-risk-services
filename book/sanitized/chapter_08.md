# Chapter 8: Reconciliation and the Enterprise Portfolio View

## The Risk That Nobody Owned

The first time I ran a full reconciliation cycle, I sat in a conference room with two printouts on the table. On the left, the output of our first top-down SWIFT workshop — approximately twenty top-down risks identified by the CRO, business unit heads, and senior risk officers through the structured methodology described in Chapter 6. On the right, the consolidated bottom-up submissions from every business unit — nearly two hundred risks documented using the standardised template and specialist sub-processes described in Chapter 7.

My task was to reconcile them.

The top-down list included a risk we had labelled "cross-counterparty concentration in prime brokerage services." The SWIFT workshop had surfaced it through the guide word prompt "Where are the gaps between what we see at the business unit level and what we would see at the enterprise level?" One of the participants had observed that several business lines appeared to hold exposure to the same cluster of counterparties through different product types — equity financing, derivatives, and securities lending — but that no single view of the aggregate existed.

I cross-referenced this against the bottom-up submissions. Not a single business unit had included it.

This was not because the bottom-up process had failed. Each business unit had performed genuine identification. The equity financing desk had reported counterparty credit risk against its positions. The derivatives desk had reported market risk and counterparty risk within its own book. The securities lending desk had reported operational risk in its collateral management. Each submission was complete, well-documented, and accurate within its scope. But the risk that the workshop had identified — the aggregate, cross-product exposure to a common set of counterparties — existed between business units, not within them.

This is the question that reconciliation is designed to answer: who owns this risk?

No one. No business unit's risk assessment had captured it because no business unit's remit encompassed it. It was not a credit risk, a market risk, or an operational risk as any individual desk would define those terms. It was an enterprise risk — visible only when you placed the two lists side by side and looked for what neither track had captured alone.

This is where reconciliation becomes politically charged. If risks are merely compiled from existing registers, they arrive with ownership already assigned — the credit risk function owns credit risks, the market risk function owns market risks, and so on. The organisational machinery knows what to do with them. But when reconciliation surfaces a new risk — one that lives between business units, one that no existing function has claimed — someone must be assigned ownership. And generally, no one wants it.

Worse, the process can create friction with the specialist risk functions themselves. If enterprise risk management highlights a market risk or a credit risk that the specialist function has not identified, it can be perceived as undermining their competence. The market risk team does not welcome being told by a cross-functional process that there is a market risk they have missed. The credit risk team does not welcome an enterprise-level reconciliation revealing a concentration they have not flagged. This is a natural institutional reaction, and it must be managed carefully. The governance framework established in Chapter 3 provides the structural answer: the Risk Identification Lead holds a mandate from the CRO to assign risk ownership based on analytical judgement, not organisational willingness. The assignment hierarchy described later in this chapter provides the operational answer: risks with a natural business unit home go to that unit; risks spanning multiple units go to the unit with the largest exposure; genuinely enterprise-level risks are owned at CRO or Group Risk level. But the political answer matters as much as the structural one. Enterprise-level risks surfaced through reconciliation are not indictments of the specialist functions — they are risks that *by definition* no single function could have seen, because they exist between organisational boundaries. Framing them this way — as structural blind spots rather than failures of competence — is essential to maintaining the trust and cooperation that the process depends on.
...
The Archegos Capital Management collapse of March 2021 illustrates why reconciliation matters. Credit Suisse lost $5.5 billion on total return swap exposure that was aggregated across multiple prime brokers — cross-counterparty, cross-product concentration that was invisible to any single business unit's assessment. It is precisely the kind of risk that reconciliation is designed to surface: an enterprise-level exposure that exists between business units, not within them.
...
In practice, a first reconciliation cycle typically produces a significant number of gaps — a dozen or more top-down risks with no bottom-up match and fifty or more bottom-up risks with no top-down equivalent. Each required investigation. Some top-down gaps reflected genuinely enterprise-level risks with no natural BU owner — cross-border regulatory divergence, for instance, which no single business unit experienced as a risk but which the SWIFT workshop had identified as a strategic concern. Some reflected bottom-up identification failures that required remediation — risks that clearly fell within a business unit's scope but had not been captured, often because the prior year's submission had been rolled forward without genuine re-identification. Some bottom-up gaps contained risks of strategic significance that the workshop had not considered — process-level vulnerabilities that, when aggregated, constituted material operational exposure.
...
In my experience, the challenge sessions are the most productive — and the most uncomfortable — part of the entire process. A business unit head who had dismissed a top-down risk as theoretical would discover that his own unit's bottom-up submission contained the evidence for it — the driver fields in the template, when examined, pointed directly to the mechanism the workshop had identified. A senior risk officer who had championed a risk in the workshop would learn that the bottom-up data showed effective controls already in place, with documented evidence of preventive and detective measures that the top-down discussion had not considered.

In one session, the investment banking division challenged the workshop's identification of model risk in a specific product class. The bottom-up submission had rated the relevant controls as effective. The challenge session required the division to present the evidence for that rating. When examined, the "effective" rating was based on the fact that the model had been validated — but the validation had been performed two years earlier, against data from a different market regime. The challenge session produced a reassessment, a revised data quality rating, and a commitment to revalidate. Neither the top-down workshop nor the bottom-up template had generated that outcome alone. The structured confrontation between them did.

The challenge sessions were where analysis displaced opinion, and where the reconciled inventory earned its credibility.
...
This is the deliverable that justifies the entire dual-track methodology. It feeds directly into the principal risk report that the Board Risk Committee receives (established in Chapter 3), the CCAR Material Risk Inventory that the quarterly re-identification cycle maintains (established in Chapter 6), and the integration processes that connect risk identification to capital planning, strategy, and regulatory reporting (Chapter 12).

The enterprise risk map is not static. As the ongoing cycle described in Chapter 13 refreshes the risk inventory through quarterly re-identification, event-driven updates, and annual full re-identification, the enterprise portfolio view is updated to reflect the current aggregated position. Correlation assumptions are tested against emerging data. Concentration patterns are monitored. New common exposures are identified as the institution's business mix evolves.

Phase 2 of the methodology — dual-track identification, reconciliation, and the enterprise portfolio view — is now complete. The institution has moved from two separate identification processes to a single, reconciled, aggregated picture of its risk landscape. Every risk in the inventory has a taxonomy classification, a named owner, a documented source (top-down, bottom-up, or both), and a position within the enterprise portfolio view.
