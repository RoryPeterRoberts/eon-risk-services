...
In early 2017, I sat in a conference room at a European G-SIB with two printouts on the table. On the left, the output of our first top-down SWIFT workshop — just over twenty risks identified by the CRO, business unit heads, and senior risk officers through the structured methodology described in Chapter 6 (Top-Down Identification: Workshops, SWIFT, and Delphi). On the right, the consolidated bottom-up submissions from every business unit — nearly two hundred risks documented using the standardised template and specialist sub-processes described in Chapter 7 (Bottom-Up Identification: Templates, RCSA, and Specialist Processes).
...
At Institution A, the challenge sessions were the most productive — and the most uncomfortable — part of the entire process. A business unit head who had dismissed a top-down risk as theoretical would discover that his own unit's bottom-up submission contained the evidence for it — the driver fields in the template, when examined, pointed directly to the mechanism the workshop had identified. A senior risk officer who had championed a risk in the workshop would learn that the bottom-up data showed effective controls already in place, with documented evidence of preventive and detective measures that the top-down discussion had not considered.
