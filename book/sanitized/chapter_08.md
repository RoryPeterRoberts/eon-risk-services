...
The reconciliation process begins when two outputs meet: the top-down SWIFT workshop results — typically twenty risks identified by the CRO, business unit heads, and senior risk officers through structured methodology — and the consolidated bottom-up submissions from every business unit — typically one hundred to two hundred risks documented using standardised templates and specialist sub-processes.

The task is to reconcile them.

A top-down workshop identifies a risk labelled "cross-counterparty concentration across business lines." The SWIFT prompt "Where are the gaps between what we see at the business unit level and what we would see at the enterprise level?" has surfaced an observation: several business lines hold exposure to the same cluster of counterparties through different product types — equity financing, derivatives, and securities lending — but no single view of the aggregate exists.

Cross-reference against the bottom-up submissions. Not a single business unit has included it.

This is not because the bottom-up process has failed. Each business unit has performed genuine identification. The equity financing desk has reported counterparty credit risk against its positions. The derivatives desk has reported market risk and counterparty risk within its own book. The securities lending desk has reported operational risk in its collateral management. Each submission is complete, well-documented, and accurate within its scope. But the risk that the workshop identified — the aggregate, cross-product exposure to a common set of counterparties — exists between business units, not within them.

The question that reconciliation is designed to answer: who owns this risk?

No one. No business unit's risk assessment captures it because no business unit's remit encompasses it. It is not a credit risk, a market risk, or an operational risk as any individual desk would define those terms. It is an enterprise risk — visible only when the two lists are placed side by side and examined for what neither track has captured alone.
...
A typical first reconciliation cycle produces a dozen top-down risks with no bottom-up match and nearly fifty bottom-up risks with no top-down equivalent. Each requires investigation. Some top-down gaps reflect genuinely enterprise-level risks with no natural business unit owner — cross-border regulatory divergence, for instance, which no single business unit experiences as a risk but which SWIFT workshops often identify as a strategic concern. Some reflect bottom-up identification failures that require remediation — risks that clearly fall within a business unit's scope but have not been captured, often because the prior year's submission was rolled forward without genuine re-identification. Some bottom-up gaps contain risks of strategic significance that workshops have not considered — process-level vulnerabilities that, when aggregated, constitute material operational exposure.
...
In practice, challenge sessions are the most productive — and the most uncomfortable — part of the reconciliation process. A business unit head who has dismissed a top-down risk as theoretical may discover that their own unit's bottom-up submission contains the evidence for it — the driver fields in the template, when examined, point directly to the mechanism the workshop identified. A senior risk officer who championed a risk in the workshop may learn that the bottom-up data shows effective controls already in place, with documented evidence of preventive and detective measures that the top-down discussion had not considered.

In one documented case, an investment banking division challenged the workshop's identification of model risk in a specific product class. The bottom-up submission had rated the relevant controls as effective. The challenge session required the division to present the evidence for that rating. When examined, the "effective" rating was based on the fact that the model had been validated — but the validation had been performed two years earlier, against data from a different market regime. The challenge session produced a reassessment, a revised data quality rating, and a commitment to revalidate. Neither the top-down workshop nor the bottom-up template had generated that outcome alone. The structured confrontation between them did.
