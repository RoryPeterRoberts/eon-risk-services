...
In early 2017, I sat in a conference room in Credit Suisse's London office with two printouts on the table. On the left, the output of our first top-down SWIFT workshop — twenty-three risks identified by the CRO, business unit heads, and senior risk officers through the structured methodology described in Chapter 6 (Top-Down Identification: Workshops, SWIFT, and Delphi). On the right, the consolidated bottom-up submissions from every business unit — one hundred and eighty-seven risks documented using the standardised template and specialist sub-processes described in Chapter 7 (Bottom-Up Identification: Templates, RCSA, and Specialist Processes).
...
Chapter 6 (Top-Down Identification: Workshops, SWIFT, and Delphi) established that the top-down track identifies approximately twenty risks of strategic significance. Chapter 7 (Bottom-Up Identification: Templates, RCSA, and Specialist Processes) established that the bottom-up track identifies one hundred to five hundred risks of operational and specialist detail. Both tracks are necessary. Neither alone is sufficient.
...
A business unit submits a risk that, when examined in the context of the full institution, represents a material enterprise exposure. The operational risk of a single cloud provider outage, for example, might appear manageable when reported by one business unit. But when the Risk Identification Lead discovers that five critical functions across three business units depend on the same provider, the risk transforms from a local operational concern into a systemic enterprise dependency. Chapter 7 (Bottom-Up Identification: Templates, RCSA, and Specialist Processes) established this principle — the failure of that provider is not five independent operational risks but one systemic risk.
...
The analysis is scenario-based. The Risk Identification Lead constructs a set of plausible stress events — drawn from the PESTLE assessment (Chapter 5 (Setting the Context: External, Internal, and Risk Culture)), the scenario analysis performed in the SWIFT workshop (Chapter 6 (Top-Down Identification: Workshops, SWIFT, and Delphi)), and the industry loss database — and traces which risks across the reconciled inventory would activate under each scenario. A sudden interest rate shock, for example, might simultaneously trigger market risk losses in the trading book, credit risk deterioration in the lending portfolio, liquidity risk as funding costs increase, and operational risk as systems designed for a low-rate environment encounter processing exceptions.
