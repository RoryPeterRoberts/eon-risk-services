...
The fourteen-field structure can be implemented in a spreadsheet. I know this because I have done it — at Credit Suisse, the initial inventory was built in a structured spreadsheet before the institution invested in dedicated GRC (governance, risk, and compliance) technology. A well-structured spreadsheet with defined fields, data validation, change tracking, and version control can serve as a functional inventory for the early cycles of a risk identification programme.
